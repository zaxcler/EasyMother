 ...
 */
package com.easymother.adapter;
...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(BaseInfo.BASE_URL+BaseInfo.BASE_PICTURE+imageUrl, view, MyApplication.options_photo);
        return this;
    }
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl,int Round) {
    	ImageView view = retrieveView(viewId);
    	return this;
    }
