...
public class CustomDialog extends Dialog
{
	...
	public static class Builder
	{
		...
		private String title = "温馨提示"; // 对话框标题
		 ...
		 * @return
		 */
		public CustomDialog create(boolean canceledOnTouchOutside)
		{
			...
			else
			{
				...
				layout.findViewById(R.id.cancel_btn).setBackgroundResource(R.drawable.white_solid);
			}
			...
			else
			{
				...
				layout.findViewById(R.id.second_line).setVisibility(View.GONE);
				layout.findViewById(R.id.confirm_btn).setBackgroundResource(R.drawable.white_solid);
			}
